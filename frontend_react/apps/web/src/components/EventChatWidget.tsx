...
export function EventChatWidget({ event }: Props) {
  ...
  return (
    ...
    <div className="fixed bottom-[112px] right-6 z-50 flex flex-col items-end gap-3">
        ...
        >
          ...
          >
            <div className="flex items-center gap-2.5">
              <div className="w-8 h-8 rounded-xl flex items-center justify-center bg-[#F2EFEA]/20">
                <svg className="w-4 h-4 text-[#F2EFEA]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                  <path strokeLinecap="round" strokeLinejoin="round" d="M9.813 15.904 9 18.75l-.813-2.846a4.5 4.5 0 0 0-3.09-3.09L2.25 12l2.846-.813a4.5 4.5 0 0 0 3.09-3.09L9 5.25l.813 2.846a4.5 4.5 0 0 0 3.09 3.09L15.75 12l-2.846.813a4.5 4.5 0 0 0-3.09 3.09ZM18.259 8.715 18 9.75l-.259-1.035a3.375 3.375 0 0 0-2.455-2.456L14.25 6l1.036-.259a3.375 3.375 0 0 0 2.455-2.456L18 2.25l.259 1.035a3.375 3.375 0 0 0 2.456 2.456L21.75 6l-1.035.259a3.375 3.375 0 0 0-2.456 2.456Z" />
                </svg>
              </div>
              <div>
                <p className="text-[13px] font-bold text-[#F2EFEA] leading-none">Event Assistant</p>
                <p className="text-[11px] text-[#F2EFEA]/70 truncate mt-0.5" style={{ maxWidth: 180 }}>
                  {event.title}
                </p>
              </div>
            </div>
            <button
              ...
              className="w-7 h-7 rounded-lg flex items-center justify-center bg-[#F2EFEA]/15 hover:bg-[#F2EFEA]/25 transition-colors"
            >
              <svg className="w-4 h-4 text-[#F2EFEA]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                ...
                <div className="shrink-0 px-3 py-3 border-t" style={{ borderColor: "#E2DDD5" }}>
                  <div className="flex items-center gap-2 px-3 py-2 rounded-xl" style={{ border: "1px solid #E2DDD5", backgroundColor: LINEN }}>
                    ...
                    <button
                      ...
                      style={{ backgroundColor: GREEN }}
                    >
                      <svg className="w-3.5 h-3.5 text-[#F2EFEA]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2.5}>
      ...
      >
        {open ? (
          <svg className="w-6 h-6 text-[#F2EFEA]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
            <path strokeLinecap="round" strokeLinejoin="round" d="M6 18 18 6M6 6l12 12" />
          </svg>
        ) : (
          <svg className="w-6 h-6 text-[#F2EFEA]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.8}>
            <path strokeLinecap="round" strokeLinejoin="round" d="M9.813 15.904 9 18.75l-.813-2.846a4.5 4.5 0 0 0-3.09-3.09L2.25 12l2.846-.813a4.5 4.5 0 0 0 3.09-3.09L9 5.25l.813 2.846a4.5 4.5 0 0 0 3.09 3.09L15.75 12l-2.846.813a4.5 4.5 0 0 0-3.09 3.09ZM18.259 8.715 18 9.75l-.259-1.035a3.375 3.375 0 0 0-2.455-2.456L14.25 6l1.036-.259a3.375 3.375 0 0 0 2.455-2.456L18 2.25l.259 1.035a3.375 3.375 0 0 0 2.456 2.456L21.75 6l-1.035.259a3.375 3.375 0 0 0-2.456 2.456Z" />
          </svg>
        )}
